...
MEN02                  dc.b "2- Enviar Dado"
                       dc.b $00 ; fim de mensagem
MEN03                  dc.b 'Digite a opção:'
MEN04                  ; endereço seguinte ao da string anterior
MEN05                  dc.b 'Digite o código do Comando (em hexadecimal):'
MEN06                  ; endereço seguinte ao da string anterior
MEN07                  dc.b 'Digite o código do Caractere (em hexadecimal):'
MEN08                  ; endereço seguinte ao da string anterior